...
class assMusicQuestionGUI extends assQuestionGUI
{
    ...
    function getTestOutput($active_id, $pass = NULL, $is_postponed = FALSE, $use_post_solutions = FALSE, $show_feedback = FALSE)
    {
        ...
        $template->setVariable("CHORD",$this->plugin->txt("chord"));
        $template->setVariable("SCALE",$this->plugin->txt("scale"));
        $template->setVariable("ON",$this->plugin->txt("on"));
        $template->setVariable("OFF",$this->plugin->txt("off"));
        $template->setVariable("SOUND",$this->plugin->txt("sound"));
        $template->setVariable("DISPLAYFORMAT",$this->plugin->txt("displayformat"));
