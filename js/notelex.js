...
function renderKeys(keys, canvas) {
    vexFlow = Vex.Flow;
    ...
    var stave = new vexFlow.Stave(0, 0, canvas.width - 2);
    ...
    // Create Switch scale vs chord
    var scalechordSwitch;
...
function createStaveNotes(keys) {
    ...
    if (hasRootNoteCollisions || staveNotes.length > scalechordSwitch) {
